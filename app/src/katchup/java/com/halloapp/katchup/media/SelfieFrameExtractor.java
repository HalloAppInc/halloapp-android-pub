 ...
 */
public class SelfieFrameExtractor {
    ...
    public SelfieFrameExtractor(String filePath) throws IOException {
        mediaExtractor = new MediaExtractor();
        mediaExtractor.setDataSource(filePath);

        trackIndex = selectTrack(mediaExtractor);
        if (trackIndex < 0) {
