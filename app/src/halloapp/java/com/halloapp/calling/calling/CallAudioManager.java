...
/**
 * AVAudioManager manages all audio during a call
 * Copied from AppRTCAudioManager.
 * https://webrtc.googlesource.com/src/+/refs/heads/main/examples/androidapp/src/org/appspot/apprtc/AppRTCAudioManager.java
 */
...
//        if (audioDevices.size() == 2 && audioDevices.contains(AVAudioManager.AudioDevice.EARPIECE)
//                && audioDevices.contains(AVAudioManager.AudioDevice.SPEAKER_PHONE)) {
//            if (proximitySensor.sensorReportsNearState()) {
//                // Sensor reports that a "handset is being held up to a person's ear",
//                // or "something is covering the light sensor".
//                setAudioDeviceInternal(AVAudioManager.AudioDevice.EARPIECE);
//            } else {
//                // Sensor reports that a "handset is removed from a person's ear", or
//                // "the light sensor is no longer covered".
//                setAudioDeviceInternal(AVAudioManager.AudioDevice.SPEAKER_PHONE);
//            }
//        }
//    }
