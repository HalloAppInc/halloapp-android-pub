 ...
 */
public class HATextureViewRenderer extends TextureView
        implements VideoSink, RendererCommon.RendererEvents, TextureView.SurfaceTextureListener {
    private static final String TAG = "HATextureViewRenderer";
    // Cached resource name.
    private final String resourceName;
    private final RendererCommon.VideoLayoutMeasure videoLayoutMeasure =
            new RendererCommon.VideoLayoutMeasure();
    private final HASurfaceEglRenderer eglRenderer;
     ...
     */
    public HATextureViewRenderer(Context context) {
        super(context);
        this.resourceName = getResourceName();
        eglRenderer = new HASurfaceEglRenderer(resourceName);
        setSurfaceTextureListener(this);
    }
    /**
     * Standard View constructor. In order to render something, you must first call init().
     */
    public HATextureViewRenderer(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.resourceName = getResourceName();
        eglRenderer = new HASurfaceEglRenderer(resourceName);
        setSurfaceTextureListener(this);
    ...
    public void onSurfaceTextureAvailable(@NonNull SurfaceTexture surfaceTexture, int width, int height) {
        ...
        eglRenderer.surfaceCreated(surface);
    }

    @Override
    public void onSurfaceTextureSizeChanged(@NonNull SurfaceTexture surface, int width, int height) {
        eglRenderer.surfaceChanged(0, width, height);
    }

    @Override
    public boolean onSurfaceTextureDestroyed(@NonNull SurfaceTexture surface) {
        eglRenderer.surfaceDestroyed();
        return true;
    }
