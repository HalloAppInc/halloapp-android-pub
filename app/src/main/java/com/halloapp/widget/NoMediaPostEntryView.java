...
public class NoMediaPostEntryView extends FrameLayout {
    ...
    public NoMediaPostEntryView(Context context) {
        super(context);
        init();
    }

    public NoMediaPostEntryView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public NoMediaPostEntryView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        inflate(getContext(), R.layout.text_post_input_layout, this);
        ...
        sendButton = findViewById(R.id.text_send_button);
        sendButtonIcon = findViewById(R.id.text_send_icon);
    ...
    public void setSendButtonIcon(@DrawableRes int drawableRes) {
        sendButtonIcon.setImageResource(drawableRes);
    }
