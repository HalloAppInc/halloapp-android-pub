...
public class MessageBubbleLinearLayout extends LinearLayoutCompat {
    ...
    public MessageBubbleLinearLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);

        init(context);
    }

    public MessageBubbleLinearLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
