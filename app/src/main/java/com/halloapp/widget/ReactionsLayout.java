...
public class ReactionsLayout extends FrameLayout {
    ...
    public void setReactions(@NonNull List<Reaction> reactions) {
        ...
        int visibleChildCount = Math.min(MAX_REACTIONS_SHOWN, reactions.size());
        setReactionCount(visibleChildCount);
        for (int i = 0; i < visibleChildCount; i++) {
            getReactionView(i).setText(reactions.get(size - visibleChildCount + i).reactionType);
        }
    }
