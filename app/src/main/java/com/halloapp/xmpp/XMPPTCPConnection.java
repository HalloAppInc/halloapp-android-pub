...
public class XMPPTCPConnection extends AbstractXMPPConnection {
    ...
    /* begin halloapp added */
    protected void parseAndProcessAck(XmlPullParser parser) throws Exception {

        ParserUtils.assertAtStartTag(parser);

        AckStanza stanza = new AckStanza(ParserUtils.getJidAttribute(parser, "to"), parser.getAttributeValue("", "id"));
