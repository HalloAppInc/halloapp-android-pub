...
public class Post extends ContentItem {
    ...
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({TYPE_USER, TYPE_SYSTEM, TYPE_FUTURE_PROOF, TYPE_RETRACTED, TYPE_ZERO_ZONE, TYPE_VOICE_NOTE, TYPE_MOMENT, TYPE_MOMENT_ENTRY, TYPE_RETRACTED_MOMENT, TYPE_MOMENT_PSA})
