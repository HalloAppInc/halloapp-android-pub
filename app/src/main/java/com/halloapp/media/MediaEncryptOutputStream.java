...
public class MediaEncryptOutputStream extends FilterOutputStream {
    ...
    public MediaEncryptOutputStream(byte[] mediaKey, @Media.MediaType int type, OutputStream os) throws IOException {
        ...
        try {
            ...
            Log.e("MediaEncryptOutputStream: failed to create cipher", e);
            throw new IOException(e);
        }

        try {
            this.cipher.init(Cipher.ENCRYPT_MODE, new SecretKeySpec(keys.aesKey, "AES"), new IvParameterSpec(keys.iv));
        } catch (InvalidKeyException | InvalidAlgorithmParameterException e) {
            Log.e("MediaEncryptOutputStream: failed to init cipher", e);
            throw new IOException(e);
        }
        ...
        try {
            ...
            Log.e("MediaEncryptOutputStream: failed to create mac", e);
            throw new IOException(e);
        }
        ...
        try {
            ...
            Log.e("MediaEncryptOutputStream: failed to init mac", e);
            throw new IOException(e);
        }
    }
